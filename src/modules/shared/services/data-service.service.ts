...
export class DataService {
    ...
    sendTelegramBotMessage(data: TelegramMessageRequestPayload): Promise<void> {
        return this.internalHttpClientService.post(`${this.dataServiceUrl}/internal/api/v1.0/telegram-messsages`, data);
    }

    sendTelegramBotMessageInternal(data: TelegramMessageRequestPayload): Promise<void> {
        return this.internalHttpClientService.post(`${this.dataServiceUrl}/internal/api/v1.0/telegram-messsages/internal`, data);
    }
}